...
$fk_horario = '';
 ...
 //llamar mysql-login.php que contiene los datos de la base de datos para conectar
  ...
  $result_insert_nombre_personal = mysqli_query($conexion,$query_insert_nombre_personal) or die ('result_insert_nombre_personal':'.errorennombre());
...
$LetraAleatora,$numeroAleatorio=($contrasena)
  ...
  $result = mysqli_query($conexion, $query_insert_personal) or die('result_ Errorentodo:'.mysqli_error());
